...
from data_generator.utils import get_input_list, get_input_output_list
import argparse
...
def add_background(img_path, background_path, save_path, i):
    ...
    try:
        ...
        np.save(save_path.replace('.jpg', '.npy'), np.stack((map_clos, map_rows), axis=2))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--num', type=int, default=100000, required=False,
